...
WebDriver driver;
	...
	public void moveTo(By locator){
		...
		try{
			...
			System.out.println("Some exception occured while move to webelement " +locator);
		}
	}
	...
	public void doActionClick(By locator){
		...
		try{
			...
			System.out.println("Some exception occured while action click on webelement " +locator);
		}
	}
